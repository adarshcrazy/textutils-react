...
export default function About(props) {
    let style =  {
        ...
        backgroundColor: props.mode=="light"?"#fff":"#0d1c31",
    } 
    
    
    let accordianStyle =  {
        backgroundColor: props.mode=="light"?"#fff":"#1d2f4a",
    }  
    return (
        <div className="container py-4" style={style}>
            ...
            {/* <button className='btn btn-primary mt-4' onClick={handleDarmode}>{btnText}</button> */}
        </div>
